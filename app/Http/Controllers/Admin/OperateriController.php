...
class OperateriController extends Controller
{
...
//        )->get()->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
        ...
        return view('admin.operateri.index', compact('users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.operateri.create');
    }
    ...
    public function store(StoreOperaterRequest $request)
    {
        ...
        $user->text = 'Postavljeni ste za operatera u okviru orgnizacije: ' . $user->organization->name;


        Mail::to($data['email'])->send(new WelcomeMail($user));

        return redirect()->route('admin.operateri.index');
    ...
    public function edit(User $operateri)
    {
        ...
        return view('admin.operateri.edit', compact('user'));
    }
...
//        $user->roles()->sync($request->input('roles', []));
    ...
    public function show(User $operateri)
    {
        ...
        return view('admin.operateri.show', compact('user'));
    }
